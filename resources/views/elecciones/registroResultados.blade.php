...
<body>
    ...
    <div class="container">
        <form action="{{ isset($elecciones) ? url('/elecciones/' . $elecciones->id) : url('/elecciones') }}"
            ...
            @endif
            <div class="column1">
            <h2 class="form-title"> Eleccion Rector 2023</h2>
        </div>
            ...
            <div class="columns">
                <div class="column">
                   ...
                   <br>
                   <input type="text"  oninput="this.value = this.value.replace(/[^A-Za-z,. 0-9]+/g, '')" name="motivo" maxlength="60" style="width: 200px;">
              <br><br>
