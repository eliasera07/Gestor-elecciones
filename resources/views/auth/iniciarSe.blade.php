                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @error('password')
                                        <span class="invalid-feedback" style="color: red; font-size: smaller;"
                                            role="alert">
                ...
                <div style="text-align: center;">
                    <div class="form-group row mb-0">
                        <div class="col-md-8 offset-md-4">
                            ...
                            <div>
                                ¿No tienes una cuenta? <span class="register-link"
                                    onclick="window.location.href='/registro'"><br>Registrarse</span>
                            </div>
